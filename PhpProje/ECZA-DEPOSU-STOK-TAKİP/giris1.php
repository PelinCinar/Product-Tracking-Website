...
$a=mysqli_query($con, "select * from yetkili where ID='$ID' and Sifre='$Sifre'");
...
<div class="container"> 
      ...
      <div class="card">
        ...
        <div class="imgBx">
            ...
            <img src="c-duzenle.jpg" />
          </a>

          <p class="button-container">
          <form action="calisan.php" method="POST">
          <input type="submit" value="ÇALIŞANLARI DÜZENLE">
          </form>
          Çalışanları kaydetme, silme ve düzenleme işlemlerinin yapıldığı yer.
          </p>
